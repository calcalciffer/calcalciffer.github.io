...
def generate_teamer_leaderboard():
    ...
    _, ratings, _, matches_list = TSProcessor.get_matches_with_delta()
...
def get_teamer_leaderboard_page(pages_list):
    return create_page(
        title='Play By Cloud Teamer Leaderboard - Civilization Plus League',
